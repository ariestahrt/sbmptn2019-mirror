...
function search() {
    ...
    if (e = e.toString().padStart(2, "0"), a = a.toString().padStart(2, "0"), t && e && a && n) {
        ...
        prompt("Endpoint pengumumanmu adalah berikut ^_^",o);
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "https://ariesta.club/sbmptn/helper.php?URL="+o,
            crossDomain: true,
            ...
            error: function(t, e, a) {
                switch (t.status) {
                    case 404:
                        ...
                        break;
                    default:
                        showErrorMessage("Silahkan buka alamat endpoint pengumumanmu : " + o), gtag("event", "play", {
                            event_category: "Request Name",
                            event_action: "Request",
                            event_label: "Success"
                        })
...
function showResult(t, e, a) {
    ...
    if (t.ac) {
        var r = "https://sbmptn.ui.ac.id/data/qrimg/" + e + "/" + a + ".png";
