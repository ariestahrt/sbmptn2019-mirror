function pasteString(t) {
    var e = t.substring(0, 12),
        ...
        n = t.substring(14, 16),
        r = t.substring(16, 20);
    $("#nopes").val(e), $("#day").val(a), $("#month").val(n), $("#year").val(r), $("#search").focus()
}
...
function search() {
    ...
    if (e = e.toString().padStart(2, "0"), a = a.toString().padStart(2, "0"), t && e && a && n) {
        var r = "";
        12 != t.length && (r = "Nomor peserta UTBK-SBMPTN tidak sesuai."), r && showErrorMessage(r);
        var i = t.toString() + e.toString() + a.toString() + n.toString(),
            s = getPath(i),
            o = i,
            //h = dataurl + "/data/data/" + s + "/" + o + ".dwg";
            h = "https://sbmptn.its.ac.id/data/data/" + s + "/" + o + ".dwg";
            prompt("Alamat endpoint pengumumanmu adalah berikut, silahkan dibuka sebagai pembuktian", h);
        $.ajax({
            type: "GET",
            dataType: "json",
            url: h,
            ...
            success: function(t) {
                showResult(t, s, o), gtag("event", "play", {
                    event_category: "Request Name",
                    event_action: "Request",
                    event_label: "Success"
                })
            ...
            error: function(t, e, a) {
                switch (t.status) {
                    case 404:
                        showErrorMessage("Nomor peserta UTBK-SBMPTN dan/atau tanggal lahir tidak ditemukan. Pastikan nomor peserta UTBK-SBMPTN dan tanggal lahir yang Anda masukkan sudah benar."), gtag("event", "play", {
                            event_category: "Request Name",
                            event_action: "Request",
                            event_label: "404"
                        });
    ...
    } else showErrorMessage("Mohon isi nomor peserta UTBK-SBMPTN, tanggal, bulan, dan tahun lahir Anda.")
}

function showResult(t, e, a) {
    var n = t.no.substring(0, 3) + " - " + t.no.substring(3, 6) + " - " + t.no.substring(6, 8) + " - " + t.no.substring(8),
        r = t.dob.substring(0, 2) + " - " + t.dob.substring(2, 4) + " - " + t.dob.substring(4);
    if (t.ac) {
        var i = dataurl + "/data/qrimg/" + e + "/" + a + ".png";
        showAccepted(n, t.na, r, t.kpt, t.npt, t.kps, t.nps, t.bm, t.upt, i)
    } else showNotAccepted(n, t.na)
}

function showAccepted(t, e, a, n, r, i, s, o, h, c) {
...
function getPath(t) {
    var e = hashString(t),
        a = e >> 8 & 255;
    return path = (255 & e).toString().padStart(3, "0") + "/" + a.toString().padStart(3, "0"), path
}
$(document).ready(function() {
    ...
    $("#nopes").keydown(function(e) {
        return !(!e.ctrlKey && !e.metaKey || 86 != e.which) || ($.inArray(e.which, t) >= 0 || (this.value.length >= 12 ? ($("#day").text(""), $("#day").focus(), !1) : !(e.shiftKey || e.which < 48 || e.which > 58) && void 0))
    }).keyup(function() {
        if (this.value.length >= 12) return $("#day").focus(), !1
    ...
    e.on("input.fromManual", function() {
        ...
        t.val(""), t.one("input.fromPaste", function() {
            ...
            20 == n.length && a.test(n) ? pasteString(n) : 12 == n.length && a.test(n) ? $("#nopes").val(n) : t.val(e), t.attr("maxlength", 12)
        })
    })
});
