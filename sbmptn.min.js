...
function search() {
    ...
    if (e = e.toString().padStart(2, "0"), a = a.toString().padStart(2, "0"), t && e && a && n) {
        var i = "";
        12 != t.length && (i = "Nomor peserta UTBK-SBMPTN tidak sesuai."), i && showErrorMessage(i);
        ...
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "https://ariesta.club/sbmptn/helper.php?URL="+h,
